...
def resize_images(input_dir: str, output_dir: str, target_size: tuple = (640, 640)) -> None:
    """
...
def resize_annotations(annot_df: pd.DataFrame, target_size: tuple=(640, 640)) -> pd.DataFrame:
    """
